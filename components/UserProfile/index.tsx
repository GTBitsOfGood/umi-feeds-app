import { ScrollView, RefreshControl, View, Alert, TouchableHighlight } from 'react-native';
...
export default function UserProfile() {
    ...
    const fullAddress = authState.pickupAddresses.map(businessAddress => {
        return `${businessAddress.buildingNumber} ${businessAddress.streetAddress} \n${businessAddress.city}, ${businessAddress.state} ${businessAddress.zipCode}`
    }).join("\n\n") || "No Address"
